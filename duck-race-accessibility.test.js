...
assert(horseRace.indexOf("el.hand.contains(document.activeElement)") < horseRace.lastIndexOf('accessibility?.handleKey(event)'), 'Horse Race hand arrows must run before shared accessibility navigation.');
