...
assert(source.includes("['Mud Puddle', 'Tailwind Tile', 'Feather Cache', 'Lucky Lily Pad'].includes(card)") && source.includes('playCard(card, null, me.square)'), 'Every placed Duck Race action card must be dropped on the current player square.');
