...
assert(source.includes("if(startDialog.open)startDialog.close();if(startEvent") && source.includes('socket.emit(startEvent'), 'Enter must close the modal before sending the direct game-start request.');
